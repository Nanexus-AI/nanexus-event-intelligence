...
from nanexus_event_intelligence.adapters.frigate.evidence_reader import (
    FrigateEvidenceContentReader,
)
...
def create_app(
    ...
    app.state.evidence_content_reader = FrigateEvidenceContentReader(get_settings())
    app.add_middleware(
        CORSMiddleware,
